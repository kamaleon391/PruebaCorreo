...
function query($op,$fechaTabla,$estado,$opcion){
        ...
        else
        {
          $Tabla = "(SELECT idEditorial, Periodico, Seccion, Categoria, NumeroPagina, Autor, Fecha, Hora, Titulo, Encabezado, Texto, PaginaPeriodico, Foto, PieFoto, Activo FROM noticiasMensual WHERE Fecha='".$fechaTabla."'
                    ...
                    UNION ALL
                    SELECT idEditorial, Periodico, Seccion, Categoria, NumeroPagina, Autor, Fecha, Hora, Titulo, Encabezado, Texto, PaginaPeriodico, Foto, PieFoto, Activo FROM  noticiasDia WHERE Fecha='".$fechaTabla."'    
                   )";
        }
