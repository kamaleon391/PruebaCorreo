...
'>
 ...
 <tr>
  ...
  <tr >
    ...
    <td width='15%'  style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/exportTamaulipas.php?p=".base64_encode(base64_encode('5'))."&f=$fecha'>REPORTE</a></td>
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/exportTamaulipas.php?p=".base64_encode(base64_encode('6'))."&f=$fecha'>REPORTE</a></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/exportTamaulipas.php?p=".base64_encode(base64_encode('7'))."&f=$fecha'>Parte 1</a></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/exportTamaulipas.php?p=".base64_encode(base64_encode('8'))."&f=$fecha'>Parte 2</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
  </tr>
...
/*
//CLIENTE
$mail->AddBCC("rodper21@hotmail.com"); 
$mail->AddBCC("santana08comsoc@gmail.com"); 
$mail->AddBCC("aleman.mtz.h@gmail.com"); 
$mail->AddBCC("jannya.jaume@gmail.com"); 
$mail->AddBCC("sintesisymonitoreo@gmail.com"); 
$mail->AddBCC("mikevaldezgarcia@gmail.com"); 
$mail->AddBCC("jannya.jaume@gmail.com");
$mail->AddBCC("michmonitoreoga@yahoo.com.mx");
$mail->AddBCC("Guillermo_martinezg@gmail.com");
$mail->AddBCC("rodper21@hotmail.com");
$mail->AddBCC("santana08comsoc@gmail.com");
 
// NUEVOS
$mail->AddBCC("paulcelan1@gmail.com");
$mail->AddBCC("aleresano@gmail.com");
$mail->AddBCC("yazjavkell@hotmail.com");
$mail->AddBCC("cecilia.martin77@gmail.com");
$mail->AddBCC("francisco.salgado@almomento.mx");
// NUEVOS/    
//GA
