<?php
include '/var/www/external/services/mail/TempTestigos/querysTamaulipas.php';
...
for($opc = 1; $opc <=8; $opc++)
{
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema="EGIDIO TORRE CANTU";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$fecha);
            break;  
        case 6:
             $tema="ADMINISTRACION ESTATAL";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$fecha);
            break;    
        case 7:
             $tema="TAMAULIPAS";$subtema=" Parte 1 ";
             ArmaPdf($query,$tema,$subtema,$fecha);
            break;
        case 8:
             $tema="TAMAULIPAS";$subtema=" Parte 2 ";
             ArmaPdf($query,$tema,$subtema,$fecha);
            break;
        default:            
            break;
...
$antigua = umask(0);
    if(is_dir("/var/www/external/testigos/Tamaulipas/".$fecha."/")){
    }
    else{
        mkdir("/var/www/external/testigos/Tamaulipas/".$fecha,0777,true);
        chmod("/var/www/external/testigos/Tamaulipas/".$fecha,0777);
        umask($antigua);
    }
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    $pdf->Rect(0, 131, 250, 40, 'F');
                      ...
                      $pdf->Image('/var/www/external/services/mail/TempTestigos/logopdf.png',5,100,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,8,$tema);
                       $pdf->Image('/var/www/external/services/mail/TempTestigos/logopdf.png',5,340,30); 
             ...
             $nombre = "/var/www/external/testigos/Tamaulipas/".$fecha."/".$tema.$subtema.".pdf";
        $pdf->Output($nombre, 'F');
    }
    $periodico=array();
    $seccion=array();
