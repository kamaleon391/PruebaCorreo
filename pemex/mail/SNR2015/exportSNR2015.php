...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        case 1: // PRIMERAS PLANAS
             $tema=utf8_decode("PRIMERAS PLANAS");$subtema=" ";
        ...
        break;
        case 4:
             $tema=utf8_decode("CARTONES");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 5:
             $tema=utf8_decode("PRIMERAS PLANAS SONORA");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;           
        case 6:
             $tema=utf8_decode("COLUMNAS POLITICAS SONORA");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 7:
             $tema=utf8_decode("CARTONES SONORA");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 8:
             $tema=utf8_decode("Claudia Artemisa Pavlovich Arellano - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 9:
             $tema=utf8_decode("Gobierno Estatal - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 10:
             $tema=utf8_decode("Manuel Acosta - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 11:
             $tema=utf8_decode("Hermosillo - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 12:
             $tema=utf8_decode("Varios - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;    
        case 13:
             $tema=utf8_decode("Claudia Artemisa Pavlovich Arellano - Sonora");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 14:
             $tema=utf8_decode("Gobierno Estatal - Sonora");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 15:
             $tema=utf8_decode("Manuel Acosta - Sonora");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 16:
             $tema=utf8_decode("Hermosillo - Sonora");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 17:
             $tema=utf8_decode("Varios - Sonora");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;   
         
        /*
        case 18:
             $tema="Claudia Pavlovich Arellano - Sonora";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 19:
             $tema="Sonora - Sonora";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;   
        case 20:
        ...
        break;   
        case 23:
             $tema="COLUMNAS DE OPINION";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;   
        case 24:
