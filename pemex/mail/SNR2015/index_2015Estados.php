...
<table width='550px' align='center' cellspacing='0' border='0' style='font-size: 13px;border: solid 1px gray;'>
  <tr>
 ...
 <tr>
  ...
  <td>&nbsp;</td>
    ...
    <tr>
        ...
        <!--<td colspan='1' style='border-bottom: 1pt solid rgb(230, 230, 230);text-align:center'><b>".utf8_decode("Secciones")."</b></td>-->
    </tr>
  <tr>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>".utf8_decode("Gobernador")."</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('7'))."&f=$fecha'>REPORTE</a></td>
        <!--<td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
        <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
        <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
        <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>-->
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('8'))."&f=$fecha'>REPORTE</a></td>
    <!--<td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>-->
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('9'))."&f=$fecha'>".utf8_decode("Sección 1")."</a></td>
    <!--<td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('11'))."&f=$fecha'>".utf8_decode("Sección 2")."</a></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('12'))."&f=$fecha'>".utf8_decode("Sección 3")."</a></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('13'))."&f=$fecha'>".utf8_decode("Sección 4")."</a></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('14'))."&f=$fecha'>".utf8_decode("Sección 5")."</a></td>-->
  </tr>
  <tr>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>Javier Lamarque Cano</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('16'))."&f=$fecha'>REPORTE</a></td>
  </tr>
  <tr>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >".utf8_decode("Información General")."</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' ><a href='http://187.247.253.5/external/services/mail/SNR2015/exportSNR2015.php?p=".base64_encode(base64_encode('10'))."&f=$fecha'>REPORTE</a></td>
    <!--<td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'></td>-->
...
$mail->Subject  = utf8_decode("Sonora - Estados 2015");
$mail->WordWrap = 50;
