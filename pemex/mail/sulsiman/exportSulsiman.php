...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
             $tema="Scholas Occurrentes";$subtema=" Parte 1";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 6:
             $tema=" Scholas Occurrentes - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("Papa Francisco ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("Papa Francisco - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 9:
             $tema=utf8_decode("José María del Corral");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
             $tema=utf8_decode("José María del Corral - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 11:
             $tema=utf8_decode("Enrique Palmeyro");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 12:
             $tema="Enrique Palmeyro - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 13:
             $tema=utf8_decode("Héctor Sulaimán");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 14:
             $tema=utf8_decode("Héctor Sulaimán - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 15:
             $tema=utf8_decode("Mauricio Sulaimán");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 16:
             $tema=utf8_decode("Mauricio Sulaimán - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 17:
             $tema=utf8_decode("Arquata");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 18:
             $tema=utf8_decode("Arquata - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;

        /*******Estados******/
        case 19:
             $tema=utf8_decode("Fut val");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 20:
             $tema=utf8_decode("Fut val - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 21:
             $tema=utf8_decode("Box Val");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 22:
             $tema=utf8_decode("Box Val - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 23:
             $tema=utf8_decode("Scholas ciudadanía");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 24:
             $tema=utf8_decode("Scholas ciudadanía - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
}
...
require '../conexion.php';
    ...
    if(mysql_affected_rows()>0)
    {
         ...
         */
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,9,mostrar_fecha_completa(date('Y-m-d')));
                      //$pdf->WriteHTML($html);
