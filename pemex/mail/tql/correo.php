...
function actor($numID)//Presidentes Municipales Tlaquepaque
{
    ...
    {
        case 1:
            $actor = "Luis Armando Córdova Díaz ";
        break;

        case 2:
            $actor = "María Elena Limón García";
        break;

        case 3:
            $actor = "Carmen Lucía Pérez Camarena";
        break;

        case 4:
            $actor = "Julio César Manzano Ríos";
        break;

        case 5:
            $actor = "Alfredo Fierros Castellanos";
        break;

        case 6:
            $actor = "Norma Rosas Martínez";
        break;
    }
    return $actor;
}
...
//Query Contador de Notas Luis Córdova
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
//Query Contador de Notas Maria Limon MC
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
//Query Contador de Notas Julio Manzanno PT
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
//Query Contador de Notas Norma Rosas Humanista
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
$mensaje .='<br>
<tr>
    <td colspan="3" align="center"><img src="'.$urlP.'/external/services/mail/tql/graficaTQL.png" style="width: 500px;"></td>
 </tr>';
...
$mensaje .= recuperaDatos($qryVillanueva, $titulo = "Luis Armando Córdova Díaz", $buscar );



//QUERY  María Elena Limón García MC
$qryAlfaro="SELECT
n.cutted,
  n.Periodico as idPeriodico,
  n.idEditorial,
...
$mensaje .= recuperaDatos($qryAlfaro, $titulo = "María Elena Limón García", $buscar );




//QUERY Carmen Lucía Pérez Camarena PAN-PRD
$qryPetersen = "SELECT
n.cutted,
  n.Periodico as idPeriodico,
  n.idEditorial,
...
$mensaje .= recuperaDatos($qryPetersen, $titulo = "Carmen Lucía Pérez Camarena", $buscar );

//QUERY Julio César Manzano Ríos
...
ORDER BY o.posicion";
$buscar = array(
        "Julio César Manzano Ríos",
        "Julio Manzano Ríos",
        "Julio César Manzano",
        "Manzano Ríos"
);
$mensaje .= recuperaDatos($qryCienfuegos, $titulo = "Julio César Manzano Ríos", $buscar );

//QUERY Celia Alfredo Fierros Castellanos MORENA
...
ORDER BY o.posicion";
$buscar = array(
        "Alfredo Fierros Castellanos",
        "Alfredo Fierros",
        "Fierros Castellanos"
);
$mensaje .= recuperaDatos($qryCeliaFausto, $titulo = "Alfredo Fierros Castellanos", $buscar );


//QUERY Norma Rosas Martínez Humanista
$qryCeliaFausto = "SELECT
n.cutted,
  n.Periodico as idPeriodico,
  n.idEditorial,
...
ORDER BY o.posicion";
$buscar = array(
        "Norma Rosas Martínez",
        "Norma Rosas",
        "Rosas Martínez"
);
$mensaje .= recuperaDatos($qryCeliaFausto, $titulo = "Norma Rosas Martínez", $buscar );
...
function correo($mensaje)
{
    ...
    $mail->FromName = "Monitoreo Luis Córdova ".date("Y-m-d");

    $mail->Subject  = "Monitoreo Luis Córdova ".fecha_completa(date("Y-m-d"));  
    $mail->WordWrap = 50;
