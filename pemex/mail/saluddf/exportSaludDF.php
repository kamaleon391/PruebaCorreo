...
if (isset($_GET['p']) && isset($_GET['f'])) {
    ...
    switch ($valor) {
        case 1:
            ...
            break;
        case 2:
            $tema = utf8_decode("Columnas Políticas");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 3:
        ...
        case 5: // SSCDMX
            $tema = utf8_decode("SSCDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 6: // Secretario de Salud CDMX
            $tema = utf8_decode("Armando Ahued Ortega");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:// Jefe de Gobierno
            $tema = utf8_decode("Jefe de Gobierno");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8: // Gabinete GCDMX
            $tema = utf8_decode("Gabinete GCDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9: // Secretaria de Salud Federal
            $tema = utf8_decode("Sec. Salud Federal");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10: //ALDF
            $tema = utf8_decode("ALDF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11: // Diputados
            $tema = utf8_decode("Diputados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12: //Senadores
            $tema = utf8_decode("Senadores");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13://Organismos de Salud
            $tema = utf8_decode("Organismos de Salud");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14: // Pablo Kuri Morales
            $tema = utf8_decode("Pablo Kuri-Morales");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15:// Manuel Mondragón y Kalb
            $tema = utf8_decode("Manuel Mondragón y Kalb");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 16: // Arriola Peñalosa
            $tema = utf8_decode("Mikel Andoni Arriola Peñalosa");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 17: // Primeras Planas Ciudad
            $tema = utf8_decode("Primeras Planas Ciudad");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
    }
