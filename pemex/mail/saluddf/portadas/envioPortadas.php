...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail//saluddf/portadas/listaTestigos.php'>Portadas CDMX</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/
  ...
  $mail->Password   = "gacomunicacion2017plus";
    ...
    $mail->AddBCC("romatoscanomurillo@gmail.com");
    $mail->AddBCC("fania163@hotmail.com");
    ...
    $chapoReporte = "/var/www/external/testigos/saluddf/portadas/portadas-".DATE('Y-m-d').".pdf";
