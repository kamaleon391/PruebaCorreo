...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail//saluddf/portadas_locales/listaTestigos.php'>Portadas Locales CDMX</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "gacomunicacion2017plus";   
    ...
    $mail->AddBCC("cervantesjoseca@gmail.com");
    $mail->AddBCC("comunicacionsocial.saludgdf@gmail.com");
    $mail->AddBCC("fania163@hotmail.com");
    $mail->AddBCC("cositabella14@hotmail.com");
    ...
    $chapoReporte = "/var/www/external/testigos//saluddf/portadasLocales/portadasLocales-".DATE('Y-m-d').".pdf";
