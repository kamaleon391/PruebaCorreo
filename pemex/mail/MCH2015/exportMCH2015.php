...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        break;
        case 3:
             $tema="".utf8_decode("José Ascension Orihuela - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 4:
             $tema=utf8_decode("Luisa María Calderón - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Cartones  
        case 5:
             $tema="Silvano Aureoles Conejo - DF";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//PRD/PT           
        case 6:
        ...
        break;//Presidente  
        case 13:
             $tema="".utf8_decode("José Ascension Orihuela - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 14:
             $tema=utf8_decode("Luisa María Calderón - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Cartones  
        case 15:
             $tema="Silvano Aureoles Conejo - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//PRD/PT           
        case 16:
