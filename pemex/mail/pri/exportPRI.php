...
if (isset($_GET['p']) && isset($_GET['f'])) {
    ...
    switch ($valor) {
        ...
        case 5: // PRIMERAS PLANAS
            $tema = utf8_decode("Presidencia - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 6:
            $tema = utf8_decode("Secretaria General - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:
            $tema = utf8_decode("CEN - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8:
            $tema = utf8_decode("Diputados PRI - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9:
            $tema = utf8_decode("Senadores PRI - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10:
            $tema = utf8_decode("PRI - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11:
            $tema = utf8_decode("Comites Estatales - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12:
            $tema = utf8_decode("Ricardo Anaya - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13:
            $tema = utf8_decode("Carlos Navarrete - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14:
            $tema = utf8_decode("INE - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15:
            $tema = utf8_decode("Enrique Peña Nieto - DF");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 16: // PRIMERAS PLANAS
            $tema = utf8_decode("Presidencia - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 17:
            $tema = utf8_decode("Secretaria General - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 18:
            $tema = utf8_decode("CEN - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 19:
            $tema = utf8_decode("Diputados PRI - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 20:
            $tema = utf8_decode("Senadores PRI - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 21:
            $tema = utf8_decode("PRI - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 22:
            $tema = utf8_decode("Comites Estatales - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 23:
            $tema = utf8_decode("Ricardo Anaya - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 24:
            $tema = utf8_decode("Carlos Navarrete - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 25:
            $tema = utf8_decode("INE - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 26:
            $tema = utf8_decode("Enrique Peña Nieto - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
    }
