...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        case 4:
            ...
            break;//Cartones  
        case 5:
             $tema="Director General";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete   
        case 6:
             $tema="Admon Central";$subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 7:
        ...
        case 11:
            ...
            break; 
        case 12:
             $tema="".  utf8_decode('Gasolina');$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 13:
            ...
            break; 
        case 14:
             $tema="".  utf8_decode('Sindicato');$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;   
        case 15:
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    $pdf->Rect(0, 131, 250, 40, 'F');
                      ...
                      $pdf->Image('pemex/logopdf.png',5,100,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,8,$tema);
                       $pdf->Image('pemex/logopdf.png',5,340,30); 
                      $pdf->SetFont("arial", "B",12);
                      $pdf->setTextColor();
                      $pdf->Text(182,13,mostrar_fecha_completa(date('Y-m-d')));   
                      //$pdf->WriteHTML($html);
