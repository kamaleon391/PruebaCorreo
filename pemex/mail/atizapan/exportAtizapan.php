...
if (isset($_GET['p']) && isset($_GET['f'])) {
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
            $tema = utf8_decode("Reforma Politica CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 6:
            $tema = utf8_decode("Eruviel Avila - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:
            $tema = utf8_decode("Eruviel Avila - EDOMEX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8: // Atizapan
            $tema = utf8_decode("Atizapan - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9: // Atizapan
            $tema = utf8_decode("Atizapan - EDOMEX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10: // TLALNEPANTLA
            $tema = utf8_decode("Tlalnepantla - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11: // TLALNEPANTLA
            $tema = utf8_decode("Tlalnepantla - EDOMEX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12: // NAUCALPAN
            $tema = utf8_decode("Naucalpan - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13: // NAUCALPAN
            $tema = utf8_decode("Naucalpan - EDOMEX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14: // Cuautitlan Izcalli 
            $tema = utf8_decode("Cuautitlán Izcalli  - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15: // NAUCALPAN
            $tema = utf8_decode("Cuautitlán Izcalli - EDOMEX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
