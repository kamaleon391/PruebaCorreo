        ...
        case 5://NAVARETE PRIDA
           $query="SELECT n.idEditorial,
                   ...
                   (
                    ...
                    Autor like '%Alfonso Navarrete Prida%' OR
                    Autor like '%Alfonso Navarrete%' OR
                    Autor like 'Alfonso Navarrete Prida'  OR 
                    Autor like '%Alfonso Navarrete Prida%' OR
                    Autor like '%Navarrete Prida%' OR
                    Autor like '%titular de la STPS%' OR
                    Autor like '%varrete Prida%' OR
                    Autor like '%varretePrida%' OR
                    Autor like '%varrete P rid%' OR
                    Autor like '%varrete P rid a%' OR
                    ...
                    PieFoto like '%varrete P rid a%'
                        ...
                        ( (Encabezado like '%Alfonso%' AND Encabezado like '%Prida%') OR (Encabezado like '%Alfonso%' AND Encabezado like '%Navarrete%') OR Encabezado like '%titular de la STPS%') OR 
                        ( (PieFoto like '%Alfonso%' AND PieFoto like '%Prida%') OR
                          (PieFoto like '%Alfonso%' AND PieFoto like '%Navarrete%') OR 
                           PieFoto like '%titular de la STPS%')
                        )AND (
    Texto NOT LIKE '%exsecretario%' AND
Texto NOT LIKE '%subsecretario%' AND
Texto NOT LIKE '%Javier Lozano Alarcon%' AND
Texto NOT LIKE '%Javier Lozano%' AND
Texto NOT LIKE '%Lozano Alarcon%' AND

    Titulo NOT LIKE '%exsecretario%' AND
Titulo NOT LIKE '%subsecretario%' AND
Titulo NOT LIKE '%Javier Lozano Alarcon%' AND
Titulo NOT LIKE '%Javier Lozano%' AND
Titulo NOT LIKE '%Lozano Alarcon%' AND

    Encabezado NOT LIKE '%exsecretario%' AND
Encabezado NOT LIKE '%subsecretario%' AND
Encabezado NOT LIKE '%Javier Lozano Alarcon%' AND
Encabezado NOT LIKE '%Javier Lozano%' AND
Encabezado NOT LIKE '%Lozano Alarcon%' AND

    PieFoto NOT LIKE '%exsecretario%' AND
PieFoto NOT LIKE '%subsecretario%'  AND
PieFoto NOT LIKE '%Javier Lozano Alarcon%' AND
PieFoto NOT LIKE '%Javier Lozano%' AND
PieFoto NOT LIKE '%Lozano Alarcon%' AND

    Autor NOT LIKE '%exsecretario%' AND
Autor NOT LIKE '%subsecretario%'  AND
Autor NOT LIKE '%Javier Lozano Alarcon%' AND
Autor NOT LIKE '%Javier Lozano%' AND
Autor NOT LIKE '%Lozano Alarcon%' 
)
