...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        case 1: // PRIMERAS PLANAS
             $tema="Titular - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 2: // PRIMERAS PLANAS
             $tema="Titular - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 3:
             $tema="CONAGUA - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 4:
             $tema="CONAGUA - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 5:
             $tema="Cutzamala - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 6:
             $tema="Cutzamala - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 7:
         $tema="Presas - CDMX";$subtema=" ";
         ArmaPdf($query,$tema,$subtema);
        break;  
        case 8:
         $tema="Presas - Estados";$subtema=" ";
         ArmaPdf($query,$tema,$subtema);
        break;
        case 9:
             $tema=utf8_decode("Infraestructura Hidráulica - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 10:
             $tema=utf8_decode("Infraestructura Hidráulica - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;            
        case 11:
             $tema=utf8_decode("Sequías - CDMX");$subtema="";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 12:
             $tema=utf8_decode("Sequías - Estados");$subtema="";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 13:
             $tema="Heladas -CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 14:
             $tema="Heladas -Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 15:
             $tema="SMN - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 16:
             $tema="SMN - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 17:
             $tema="Organismos de Cuenca - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 18:
             $tema="Organismos de Cuenca - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 19:
             $tema="ANEAS - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 20:
             $tema="ANEAS - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 21:
             $tema="SEMARNAT - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 22:
             $tema="SEMARNAT - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 23:
             $tema="Ley General de Aguas - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 24:
             $tema="Ley General de Aguas - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;     
        case 25:
             $tema="Acueducto Monterrey 6 - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 26:
             $tema="Acueducto Monterrey 6 - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 27:
             $tema="Varios - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 28:
             $tema="Varios - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 29:
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,13,mostrar_fecha_completa($_GET['f']));   
                      //$pdf->WriteHTML($html);
