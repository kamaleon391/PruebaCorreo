...
function query($op,$fechaTabla)
{
        ...
        {
            $tabla="(
                SELECT idEditorial,Fecha,Titulo , PaginaPeriodico, NumeroPagina , Texto, Periodico,Autor, Hora, Encabezado, Foto,PieFoto, Seccion, Categoria, Activo FROM  noticiasDia WHERE Fecha = '".$fechaTabla."' 
                UNION ALL                
            ...
            $condicionFecha = "n.Fecha = '".$fechaTabla."' AND "; 
        }
        ...
        $query = "SELECT  'Secretario' as Tema, n.idEditorial,
                   ...
                   n.NumeroPagina,
                   s.seccion
                   FROM ".$tabla." n, (SELECT * FROM periodicos WHERE Estado = ".$op.") p,seccionesPeriodicos s,categoriasPeriodicos c, estados e
