...
/*
  ...
  /*
          ...
          mysql_select_db($database,$conect);
            ...
            mysql_close();
            */
            $objWriter->save("Reporte_SCT_Licitacion.docx");
            chmod("Reporte_SCT_Licitacion.docx", 0777);
