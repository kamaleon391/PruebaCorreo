...
(
  ...
  (
    ...
    (
      ...
      PieFoto      like '%Subsecretaria de Comunicaciones%' OR
      PieFoto      like '%Subsecretario de comunicaciones%' OR
      PieFoto      like '%jose ignacio peralta sanchez%' OR
      PieFoto      like '%jose ignacio peralta%' OR
      PieFoto      like '%jose peralta sanchez%' OR
      PieFoto      like '%peralta sanchez%'
    ) AND 
    n.Periodico=p.idPeriodico AND 
    n.Periodico=o.periodico AND 
    p.Estado = e.idEstado AND 
  ...
  (
    ...
    (
      ...
      PieFoto      like '%Subsecretaria de Transportes%' OR
      PieFoto      like '%Yuriria Mascot Perez%' OR   
      PieFoto      like '%Yuriria Mascot%' OR   
      PieFoto      like '%Mascot Perez%'
    ) AND
    n.Periodico=p.idPeriodico AND
    n.Periodico=o.periodico AND
    p.Estado = e.idEstado AND
  ...
  (
    ...
    (
      ...
      PieFoto      like '%Subsecretaria de infraestructura%' OR
      PieFoto      like '%Raul Murrieta cummings%' OR
      PieFoto      like '%Raul Murrieta%'
  ...
  (
    ...
    (
	  ...
	  PieFoto like '% SCT % ' OR
      PieFoto like '% Secretaria de Comunicaciones y Transportes %'
    ) AND 
      n.Periodico=p.idPeriodico AND 
      n.Periodico=o.periodico AND 
      p.Estado = e.idEstado AND
...
/*
        ...
        mysql_select_db($database,$conect);
          ...
          $query_id = "INSERT INTO sct_ids (idEditorial) VALUES (".implode("),(", $ids_Array).")";
          //                  $query_id = "INSERT INTO sct_ids (idEditorial) VALUES (".implode("),(", $ids_Array).")";
