...
(
  ...
  (
    ...
    AND n.Hora BETWEEN '$horaInicial' AND '$horaFinal'
    ORDER BY o.posicion
  )
  UNION ALL
  (
      ...
      while ($col = mysql_fetch_array($resultColumn))
      {
        $ids_Array[]=$col['idEditorial'];
         $idEditorial=$col['idEditorial'];
          ...
          $section->addText(urls_amigables(wordlimit2("Cancelaron el des le, yo no: Cienfuegos Declaración completa Posee Peña patrimonio de 45 mdp; un departamento, 4 viviendas y 4 terrenos  Pide IP poner orden Las protestas provocan más daños que el crimen: Coparmex de Guerrero  Líder cameral Llama Aureoles a evitar descalificaciones hacia los manifiestantes P. ")), 'estiloTitle');
...
/*          mysql_close();
        ...
        mysql_select_db($database,$conect);
          ...
          mysql_close();
          */
          $objWriter->save("FinalFaltantes.docx");
          chmod("FinalFaltantes.docx", 0777);
