...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 5:
             $tema=utf8_decode("Junta de Coordinación Política");$subtema="";
             ArmaPdf($query,$tema,$subtema);
        break;

        case 6:
             $tema="Mesa Directiva";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("Presidente de la Mesa Directiva ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("Coord. Gpo. Parlamentario PRI");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 9:
             $tema=utf8_decode("Coord. Gpo. Parlamentario PAN");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
             $tema=utf8_decode("Coord. Gpo. Parlamentario PRD");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 11:
             $tema=utf8_decode("Coord. Gpo. Parlamentario PVEM");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 12:
             $tema="Coord. Gpo. Parlamentario PES";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 13:
             $tema=utf8_decode("Coord. Gpo. Parlamentario MC");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 14:
             $tema=utf8_decode("Coord. Gpo. Parlamentario PANAL");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 15:
             $tema="Coord. Gpo. Parlamentario MORENA";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 16:
             $tema="Diputado Independiente";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 17:
             $tema=utf8_decode("Diputados Sin Partido");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;   
  }
