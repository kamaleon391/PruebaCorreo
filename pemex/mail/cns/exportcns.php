...
if(isset($_GET['p']) && isset($_GET['f'])){
    include 'queryscns.php';
    
    $varEstados = array(0,'Aguascalientes','Baja California','Baja California Sur','Campeche','Coahuila',
                   'Colima','Chiapas','Chihuahua','Distrito Federal','Durango','Guanajuato','Guerrero',
                   'Hidalgo','Jalisco','Estado de México','Michoacan','Morelos','Nayarit','Nuevo Leon',
    ...
    switch ($valor){
        ...
        case 4:
            ...
            break;//Cartones  
        case 5:
             $tema=utf8_encode( "Presidente de la Republica, parte 1" ) ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete   
        case 6:
             $tema=utf8_encode( "Presidente de la Republica, parte 2" ) ; $subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 7:
             $tema= "Secretario de Gobernacion" ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;         
        case 8:
             $tema="Comisionado de Seguridad";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 9:
             $tema="CNS";$subtema="";
            ...
            break; 
        case 10:
             $tema="Policia Federal";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 11:
             $tema="Prevención y Readaptación Social "; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 12:
             $tema="Servicio de Protección Federal"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 13:
             $tema="PGR";$subtema=" ";
        ...
        case 15:
             ...
             break;
        case 16:
             $tema=utf8_encode( "Presidente de la Republica - Estados, parte 1" ) ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete   
        case 17:
             $tema=utf8_encode( "Presidente de la Republica - Estados, parte 2" ) ; $subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 18:
             $tema= "Secretario de Gobernacion - Estados" ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;         
        case 19:
             $tema="Comisionado de Seguridad - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 20:
             $tema="CNS - Estados";$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 21:
             $tema="Policia Federal - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 22:
             $tema="Prevención y Readaptación Social - Estados"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 23:
             $tema="Servicio de Protección Federal - Estados"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 24:
             $tema="PGR - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 25:
             $tema="SEDENA - Estados"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
             break;   
        case 26:
             $tema="SEMAR - Estados"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);        
             break;   
    }
}else{
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    $pdf->Rect(0, 131, 250, 40, 'F');
                      ...
                      $pdf->Image('logopdf.png',5,70,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(90,8,$tema);
                       $pdf->Image('logopdf.png',5,335,30); 
                      $pdf->SetFont("arial", "B",11);
                      $pdf->setTextColor();
                      $pdf->Text(185,8,date('Y-m-d'));   
                      //$pdf->WriteHTML($html);
