<?php
    ...
    <br><br>
    <div style='text-align: center; font-size: 14px;'>Para mas contenido visite su <a href='http://www.gaimpresos.com/boards/corpogas'>Sistema de ".utf8_decode('Información')."</a></div>
    ";
    ...
    function sendinblue($message){
        ...
        $data   = array(
            "to" => array(
                  'impresos@info-gacomunicacion.com' => 'Correo Demo',
            ),
            "bcc" => array(
