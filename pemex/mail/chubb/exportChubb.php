...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 5:
            ...
            break;
        case 6:
             $tema=" FIANZAS ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break; 
        case 7:
             $tema=" OBRA PUBLICA DF ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 8:
             $tema="SECRETARIA DE DESARROLLO URBANO";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 9:
             $tema=utf8_decode("CHUBB / ESTADOS");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 10:
             $tema=utf8_decode("FIANZAS / ESTADOS");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 11:
             $tema=utf8_decode("OBRA PUBLICA / ESTADOS");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;               
}
