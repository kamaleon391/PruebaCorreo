...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        case 1: // PRIMERAS PLANAS
             $tema=utf8_decode("Eviel Pérez Magaña - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 2:
             $tema=utf8_decode("Alejandro Murat - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 3:
             $tema=utf8_decode("Alfonso Gómez Sandoval - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 4:
             $tema=utf8_decode("Mariana Benítez Tiburcio - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 5:
             $tema=utf8_decode("Gerardo Gutiérrez Candiani - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;           
        case 6:
             $tema=utf8_decode("José Antonio Estefan Garfias - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;     
        case 7:
             $tema=utf8_decode("Salomón Jara - CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;     
        case 8: // PRIMERAS PLANAS
             $tema=utf8_decode("Eviel Pérez Magaña - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 9:
             $tema=utf8_decode("Alejandro Murat - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 10:
             $tema=utf8_decode("Alfonso Gómez Sandoval - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 11:
             $tema=utf8_decode("Mariana Benítez Tiburcio - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 12:
             $tema=utf8_decode("Gerardo Gutiérrez Candiani - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;           
        case 13:
             $tema=utf8_decode("José Antonio Estefan Garfias - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;     
        case 14:
             $tema=utf8_decode("Salomón Jara - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 15:
             $tema=utf8_decode("Primeras Planas CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 16:
             $tema=utf8_decode("Columnas Politicas");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;           
        case 17:
             $tema=utf8_decode("Columnas Financieras");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;     
        case 18:
             $tema=utf8_decode("Cartones CDMX");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
    }
}        
