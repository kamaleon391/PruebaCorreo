...
$qryC = "SELECT DISTINCT(n.idEditorial), p.Nombre AS 'Periodico', n.Fecha, n.Titulo,s.seccion AS 'Seccion', n.PaginaPeriodico,n.NumeroPagina as 'PaginaPDF', REPLACE(n.Texto,'\n',' ') Texto,
  ...
  FROM (SELECT idEditorial,Periodico,Titulo,Fecha,Hora,Encabezado,Categoria,Seccion,Activo,Autor,Texto,NumeroPagina,PaginaPeriodico,PieFoto FROM noticiasAnual WHERE Fecha BETWEEN '2015-01-01' AND CURDATE()
UNION ALL
SELECT idEditorial,Periodico,Titulo,Fecha,Hora,Encabezado,Categoria,Seccion,Activo,Autor,Texto,NumeroPagina,PaginaPeriodico,PieFoto FROM noticiasMensual WHERE Fecha BETWEEN '2015-01-01' AND CURDATE()
UNION ALL
SELECT idEditorial,Periodico,Titulo,Fecha,Hora,Encabezado,Categoria,Seccion,Activo,Autor,Texto,NumeroPagina,PaginaPeriodico,PieFoto FROM noticiasSemana WHERE Fecha BETWEEN '2015-01-01' AND CURDATE()
UNION ALL
SELECT idEditorial,Periodico,Titulo,Fecha,Hora,Encabezado,Categoria,Seccion,Activo,Autor,Texto,NumeroPagina,PaginaPeriodico,PieFoto FROM noticiasDia WHERE Fecha BETWEEN '2015-01-01' AND CURDATE()) n, periodicos p, ordenGeneraljalisco o, estados e, seccionesPeriodicos s
  WHERE 
    p.idPeriodico=n.Periodico AND
    p.idPeriodico=o.periodico AND
...
$nombre = "/var/www/external/services/mail/chre/Reporte Chre Enero-Febrero 2015.pdf";
