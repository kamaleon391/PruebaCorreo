...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        break; 
        case 8:
             $tema=utf8_decode("Gobernador - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 9:
             $tema=utf8_decode("Francisco Dominguez Servien - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 10:
             $tema=utf8_decode("Queretaro - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 11:
             $tema=utf8_decode("Dependencias - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 12:
             $tema=utf8_decode("CONAGO - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;    
        case 13:
             $tema=utf8_decode("Gobernador - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 14:
             $tema=utf8_decode("Francisco Dominguez Servien - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 15:
             $tema=utf8_decode("Queretaro - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 16:
             $tema=utf8_decode("Dependencias - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 17:
             $tema=utf8_decode("CONAGO - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;   
