...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
             $tema="Gobernador";$subtema=" CDMX ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 6:
             $tema=" Gobernador - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("Adm. Estatal ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("Adm. Estatal - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 9:
             $tema=utf8_decode("Congreso");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
             $tema=utf8_decode("Congreso - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 11:
             $tema=utf8_decode("Mpales");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 12:
             $tema="Mpales - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 13:
             $tema=utf8_decode("Justicia");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 14:
             $tema=utf8_decode("Justicia - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 15:
             $tema="Com. Soc";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 16:
             $tema="Com. Soc - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 17:
             $tema=utf8_decode("P. Politicos");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 18:
             $tema=utf8_decode("P. Politicos - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
