...
<table width="70%" align="center" cellspacing="0" border="0" style="font-size: 12px;border: solid 1px gray;">
 <tr>
    <td colspan="3" align="center"><img src="'.$urlP.'/external/services/mail/inee/logo2.png"style="width: 280px;"></td>
 </tr>';
...
$mensaje .= recuperaDatos($qryDireccion, $titulo = "INEE - Instituto Nacional para la Evaluación de la Educación", $buscar );
...
function correo($mensaje)
{
    ...
    $mail->AddBCC("monitoreomedios@stps.gob.mx");
