...
function makePDFNacionales()
{
    ...
    $i=0; $periodico=array();  $seccion=array();$j=0;$variable=array();
    $data =  mysql_query($sqlNacionales);
    ...
    $pdf->Output("../../../../testigos/Informador/Portadas/".date('Y-m-d').$tema.$subtema.".pdf", 'D');
