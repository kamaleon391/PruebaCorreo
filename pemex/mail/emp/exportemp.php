...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        case 6:
            ...
            break; 
        case 7:
             $tema= "Primera Dama" ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;         
        case 8:
             $tema="Funcionarios Presidencia";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 9:
             $tema="Jefe Estado Mayor Presidencial";$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 10:
             $tema="Estado Mayor Presidencial";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        ...
        case 17:
            ...
            break; 
        case 18:
             $tema= "Primera Dama - Estados" ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;         
        case 19:
             $tema="Funcionarios Presidencia - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 20:
             $tema="Jefe Estado Mayor Presidencial - Estados";$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 21:
             $tema="Estado Mayor Presidencial - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;    
    }
}else{
