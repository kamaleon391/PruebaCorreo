...
if(isset($_GET['p']) && isset($_GET['f'])){
    include '/var/www/external/services/mail/tamaulipas/querysTamaulipas.php';
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema=utf8_decode("EGIDIO TORRE CANTÚ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 6:
             $tema=utf8_decode("ADMINISTRACIÓN ESTATAL");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;    
        case 7:
        ...
        case 8:
            ...
            break;
        case 9:
             $tema="PRI - Baltazar Hinojosa Ochoa ";$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
             $tema=utf8_decode("PAN - Francisco Javier García Cabeza de Vaca");$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 11:
             $tema=utf8_decode("EGIDIO TORRE CANTÚ");$subtema=" ";
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    $pdf->Rect(0, 131, 250, 40, 'F');
                      ...
                      $pdf->Text(10,23,"test");
                      $pdf->Image('/var/www/external/services/mail/tamaulipas/generico.png',5,100,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->Text(10,18,$estados[$j]." | ".(StringNamePeriodico($periodico[$j])));
                      $pdf->SetFont("arial", "B", 13);
                      $pdf->setTextColor(255,255,255);
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,8,$tema);
                      $pdf->Image('/var/www/external/services/mail/tamaulipas/generico.png',5,340,30); 
...
function StringNamePeriodico($periodico)
{
    switch($periodico)
    {
        case "Excelsior":
