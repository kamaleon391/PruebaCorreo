...
if (isset($_GET['p']) && isset($_GET['f'])) {
    ...
    switch ($valor) {
        ...
        case 5: // PRIMERAS PLANAS
            $tema = utf8_decode("Manuel Mondragón y Kalb - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 6:
            $tema = utf8_decode("CONADIC - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:
            $tema = utf8_decode("Marihuana - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8:
            $tema = utf8_decode("Tabaco - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9:
            $tema = utf8_decode("Alcohol - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10:
            $tema = utf8_decode("Drogas y Adicciones - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11:
            $tema = utf8_decode("Secretaría de Salud - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12:
            $tema = utf8_decode("Mercedes Juan López - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13:
            $tema = utf8_decode("COFEPRIS - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14:
            $tema = utf8_decode("Centros de Integración Juvenil - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15:
            $tema = utf8_decode("Presidente EPN - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 16:
            $tema = utf8_decode("Gobierno de la República - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 17:
