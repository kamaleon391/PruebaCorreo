...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        case 1:
             $tema= utf8_decode("Ricardo Villanueva Lomelí"); $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//Villanueva    
    
        case 4:
             $tema= utf8_decode("Enrique Alfaro Ramírez"); $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//Alfaro    
    
        case 7:
             $tema= utf8_decode("Alfonso Petersen Farah"); $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//Petersen    
    
        case 10:
             $tema= utf8_decode("Guadalajara"); $subtema="";
             ArmaPdf($query,$tema,$subtema);
        break;//Petersen    
