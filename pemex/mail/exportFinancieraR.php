...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema="FINANCIERA NACIONAL DE DESARROLLO";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;
        case 6:
             $tema=utf8_decode("DIRECCIÓN GENERAL ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break; 
        case 7:
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('FinancieraRural/Logo.png',5,100,140); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$tema);
                       $pdf->Image('FinancieraRural/Logo.png',5,340,50); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
