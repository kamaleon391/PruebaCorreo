...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
             $tema="Director General";$subtema=" Parte 1";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 6:
             $tema=" Director General - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("Reforma Energética ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("Reforma Energética - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 9:
             $tema=utf8_decode("Petróleo");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
            ...
            break;
        case 11:
             $tema=utf8_decode("Gas");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 12:
             $tema="Gas - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 13:
             $tema=utf8_decode("Petroquímica");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 14:
            ...
            break;
        case 15:
             $tema="Gasolina";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 16:
             $tema="Gasolina - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 17:
             $tema=utf8_decode("Reforma Laboral");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 18:
        ...
        /*******Estados******/
        case 19:
             $tema=utf8_decode("Refinación");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 20:
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('top_pemex.jpg',5,100,100);
        ...
        for($j=0;$j<sizeof($periodico);$j++)
        {
            if(file_exists($variable[$j])){
                      ...
                      $pdf->Cell(0,0,  ($tema).  ($subtema),0,'','R');
                       $pdf->Image('top_pemex.jpg',5,340,30);
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
