...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        case 1: // PRIMERAS PLANAS
             $tema="Grupo GIN - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 2:
             $tema="Grupo GIN - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 3:
             $tema="Mediabusiness - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 4:
             $tema=("Mediabusiness - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 5:
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    $pdf->setTextColor();
                      ...
                      $pdf->Image('LOGOgin.png',5,100,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j]))
                {
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(150,8,$tema);
                       $pdf->Image('LOGOgin.png',5,340,30); 
