...
$report = new WebReport(date('Y-m-d'), 'http://187.247.253.5/external/services/mail/mahahual/top_mahahual.jpg', 'http://187.247.253.5/external/services/mail/mahahual/top_mahahual.jpg', ['4352','4353','4354','4355','4356','4357','4358']);
...
//echo $report->message;
 ...
 /* PREPARA OBJETO DE ENVIO...*/
  ...
  $data   = array(
    ...
    "subject" => "Mahahual Monitoreo de Medios",
    "html" => utf8_encode($report->message),
    "headers" => array("Content-Type"=> "text/html; charset=UTF-8", "X-Mailin-Tag" => "Impresos-Mahahual")
);
