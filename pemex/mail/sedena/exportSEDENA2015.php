...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        break; 
        case 8:
             $tema=utf8_decode("Secretario - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 9:
             $tema=utf8_decode("Administración Central - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 10:
             $tema=utf8_decode("Zonas Militares - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
        case 11:
             $tema=utf8_decode("Secretario - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 12:
        ...
        break;    
        case 13:
             $tema=utf8_decode("Administracion Central - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 14:
             $tema=utf8_decode("Zonas Militares - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break; 
        case 15:
