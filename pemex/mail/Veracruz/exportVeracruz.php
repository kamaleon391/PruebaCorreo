...
if (isset($_GET['p']) && isset($_GET['f'])) {
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
            $tema = utf8_decode("Héctor Yunes Landa - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 6:
            $tema = utf8_decode("Héctor Yunes Landa - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:
            $tema = utf8_decode("Miguel Ángel Yunes Linares - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8:
            $tema = utf8_decode("Miguel Ángel Yunes Linares - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9:
            $tema = utf8_decode("Gobernador de Veracruz - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10:
            $tema = utf8_decode("Gobernador de Veracruz - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11:
            $tema = utf8_decode("Veracruz - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12:
            $tema = utf8_decode("Veracruz - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13:
            $tema = utf8_decode("Partidos Politicos - CDMX");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14:
            $tema = utf8_decode("Dependencias - Veracruz");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15:
            $tema = utf8_decode("Partidos Politicos - Estados");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
