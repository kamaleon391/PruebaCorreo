...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        case 4:
            ...
            break;//Cartones  
        case 5:
             $tema="PROFEPA";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete   
        case 6:
             $tema="PROFEPA - ". $varEstados[$estado]; $subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 7:
            ...
            break;         
        case 8:
             $tema="Procurador - ". $varEstados[$estado];$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 9:
            ...
            break; 
        case 10:
             $tema="Delegaciones - ". $varEstados[$estado];$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 11:
             $tema="SEMARNAT"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 12:
             $tema="SEMARNAT - ". $varEstados[$estado]; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 13:
             $tema="Varios";$subtema=" ";
            ...
            break; 
        case 14:
             $tema="Varios - ". $varEstados[$estado]; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;   
    }
}else{
