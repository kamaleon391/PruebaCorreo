       ...
       $FechaCliente = strtotime($Tabla);
        ...
        case 5: /*********** PROFEPA - DF ************/
           $query="SELECT n.idEditorial,
                   ...
                   fecha =DATE('$fecha') AND
                   (
                        Texto like'%procuraduria federal de proteccion al medio ambiente%' OR
                        Texto like '%profepa%' OR
                        Texto like '%Procuraduria Federal de Proteccion al Ambiente%' OR
                          Texto like '%Procuraduria Federal del Ambiente%' OR
                        
                        Titulo like'%procuraduria federal de proteccion al medio ambiente%' OR 
                        Titulo like '%profepa%'  OR 
                        Titulo like '%Procuraduria Federal de Proteccion al Ambiente%' OR
                        Titulo like '%Procuraduria Federal del Ambiente%' OR
                        
                        Encabezado like '%procuraduria federal de proteccion al medio ambiente%' OR
                        Encabezado like '%profepa%' OR
                        Encabezado like '%Procuraduria Federal de Proteccion al Ambiente%' OR
                        Encabezado like '%Procuraduria Federal del Ambiente%' OR

                        Texto like'%MANUEL MERCADO BEJAR%' OR
                        Texto like'%MERCADO BEJAR%' OR
                        Texto like'%Alejandro Del Mazo Maza%' OR
                        Texto like'%Canek Vazquez Gongora%' OR
                        Texto like'%Canek Gongora%' OR
                        Texto like'%Canek Vazquez%' OR
                        Texto like'%Vazquez Gongora%' OR
                        Texto like'%Arturo Rodriguez Avitia%' OR
                        Texto like'%Rodriguez Avitia%' OR
                        Texto like'%fernando reina iglesias%' OR
                        Texto like'%reina iglesias%' OR

                        Titulo like'%MANUEL MERCADO BEJAR%' OR
                        Titulo like'%MERCADO BEJAR%' OR
                        Titulo like'%Alejandro Del Mazo Maza%' OR
                        Titulo like'%Canek Vazquez Gongora%' OR
                        Titulo like'%Canek Gongora%' OR
                        Titulo like'%Canek Vazquez%' OR
                        Titulo like'%Vazquez Gongora%' OR
                        Titulo like'%Arturo Rodriguez Avitia%' OR
                        Titulo like'%Rodriguez Avitia%' OR
                        Titulo like'%fernando reina iglesias%' OR
                        Titulo like'%reina iglesias%' OR

                        Encabezado like'%MANUEL MERCADO BEJAR%' OR
                        Encabezado like'%MERCADO BEJAR%' OR
                        Encabezado like'%Alejandro Del Mazo Maza%' OR
                        Encabezado like'%Canek Vazquez Gongora%' OR
                        Encabezado like'%Canek Gongora%' OR
                        Encabezado like'%Canek Vazquez%' OR
                        Encabezado like'%Vazquez Gongora%' OR
                        Encabezado like'%Arturo Rodriguez Avitia%' OR
                        Encabezado like'%Rodriguez Avitia%' OR
                        Encabezado like'%fernando reina iglesias%' OR
                        Encabezado like'%reina iglesias%' 
                       ) 
                    GROUP BY p.idPeriodico,n.PaginaPeriodico
                    ORDER BY o.posicion";
            return $query;      
        break;//
        case 6: /*********** PROFEPA - ESTADOS ************/
            $query="SELECT n.idEditorial,
                    n.Periodico as 'idPeriodico',
                    p.Nombre as 'periodico',n.Seccion,s.seccion,n.Categoria as 'Num.Categoria',c.Categoria as 'Categoria',n.NumeroPagina,n.Autor,n.Fecha,n.Hora,n.Titulo,n.Encabezado,n.Texto,n.PaginaPeriodico,n.Foto,n.PieFoto,
                    CONCAT('/var/www/Sistema-de-Captura/Periodicos/',p.Nombre,'/',n.Fecha,'/',NumeroPagina) AS 'pdf',
        ...
        case 11: /***********     DF     ************/
           $query="SELECT n.idEditorial,
                   ...
                   (
                        ...
                        Texto like '%Juan Jose Guerra Abud%' OR
                        Texto like '%Juan Guerra Abud%' OR
                        Texto like '%Jose Guerra Abud%' OR
                        Texto like '%Guerra Abud%' OR
                        Texto like '%Secretaria de Medio Ambiente%' OR
                        Texto like '%secretarias de Medio Ambiente%' OR

                        Titulo like '%SEMARNAT%'  OR
                          Titulo like '%(semarnat)%' OR
                        Titulo like '%secretaria de medio ambiente y recursos naturales%' OR
                        Titulo like '%secretaria de medio ambiente%' OR
                        Titulo like '%Juan Jose Guerra Abud%' OR
                        Titulo like '%Juan Guerra Abud%' OR
                        Titulo like '%Jose Guerra Abud%' OR
                        Titulo like '%Guerra Abud%' OR

                        Encabezado like '%SEMARNAT%' OR
                    Encabezado like '%(semarnat)%' OR
                        Encabezado like '%secretaria de medio ambiente y recursos naturales%' OR
                        Encabezado like '%secretaria de medio ambiente%' OR
                        Encabezado like '%Juan Jose Guerra Abud%' OR
                        Encabezado like '%Juan Guerra Abud%' OR
                        Encabezado like '%Jose Guerra Abud%' OR
                        Encabezado like '%Guerra Abud%'
                       )
                    GROUP BY p.idPeriodico,n.PaginaPeriodico
                    ORDER BY o.posicion";
            return $query;      
