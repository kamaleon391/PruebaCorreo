 ...
 $mensaje ='
  ...
  { 
      while ( $row = mysql_fetch_array($result) ) 
      {
        ...
        $mensaje .='
              <tr>
                <td colspan="3" align="left" style="font-weight:bold;FONT-SIZE: 14px;background: #e6e7ed;"><strong>'.utf8_decode($periodico).':</strong> &nbsp; </td>
              </tr>
              <tr>
                <td colspan="1" style="text-align:left; font-weight:bold;FONT-SIZE: 14px;">'.utf8_decode(sanear_string2($titulo)).'</td>
              </tr>
              <tr>
                <td colspan="3" style="text-align:justify;font-family: Arial Narraow;font-size: 14px;">
                  '.utf8_decode(wordlimit($texto)).'
                </td>
              </tr>
              <tr>
                <td colspan="3" align="left"><strong>Secci&oacute;n : </strong>'.$row['seccion'].'&nbsp;  &nbsp; &nbsp;<strong>Autor: </strong>'.utf8_decode(ucwords(strtolower($row['Autor']))).'</td>
              </tr>
              <tr>
                <td colspan="3">
        ...
        while ( $row = mysql_fetch_array($result) ) 
        {
            ...
            $mensaje .='
                  <tr>
                    ...
                    <a href="'.$urlP.'/'.$row['pdf'].'" target="_blank" style="color:blue;"><span style="font-family: Arial Narrow;line-height: 35px;margin-left: 10px;font-family: Arial Narrow;font-size: 15px;font-weight: bold;text-transform: uppercase;font-family: Arial Narrow;">'.utf8_decode($titulo).'</span></a></th>
