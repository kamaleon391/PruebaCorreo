...
include '/var/www/external/services/mail/liconsa/querysLiconsa2.php';
    ...
    //$tabla=defineFecha($fecha);
      ...
      switch ($i) 
      {
          ...
          case 4:
              ...
              break;  
          case 5:
               $tema=" HECTOR PABLO RAMIREZ";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break;
          case 6:
               $tema=" GERENCIA LICONSA ";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break; 
          case 7:
               $tema="LICONSA ";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break;    
          case 8:
               $tema="TEMA LECHE ";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break;   
          case 9:
               $tema="SEDESOL";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break;   
          case 10:
               $tema="VARIOS TEMAS";$subtema=" ";
               ArmaPdf($query,$tema,$subtema,$fecha);                      
              break;         
      }
  }  
...
$antigua = umask(0);
if(is_dir("/var/www/external/testigos/Liconsa/".$fecha."/")){
}
else{
    mkdir("/var/www/external/testigos/Liconsa/".$fecha,0777,true);
    chmod("/var/www/external/testigos/Liconsa/".$fecha,0777);
    umask($antigua);
}   
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                      $pdf->Image('/var/www/external/services/mail/liconsa/logopdf2.png',5,100,100);
                      $pdf->SetFont("arial", "B",15);
                      $pdf->setTextColor();
                      $pdf->Text(140,177,mostrar_fecha_completa( $fecha ));   
        //
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$tema);
                       $pdf->Image('/var/www/external/services/mail/liconsa/logopdf2.png',5,340,30); 
        ...
        $nombre = "/var/www/external/testigos/Liconsa/".$fecha."/".$npdf.".pdf";
        $pdf->Output($nombre, 'F');        
