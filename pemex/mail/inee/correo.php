...
function recuperaDatos($sql, $titulo, $buscar = array(),$tipo)
{
  ...
  //$urlP = "http://192.168.3.154";
    ...
    if(mysql_affected_rows() > 0)
    {
      ...
      {
        static $notasexistentes = array();
        if(!in_array($row['idEditorial'],$notasexistentes))
        {
          ...
          $mensaje .='
            ...
            */
            ...
            $mensaje .='
                  <div style="text-align:left; font-weight:bold;font-size: 16px;">'.sanear_string2($titulo).' - '.$periodico.' - '.$row['NumeroPagina'].' - '.$autor.' - '.$row['seccion'].'</div><br>
            ...
            if($tipo==1)
            {
              $mensaje .= '<a href="'.$urlP.$row['pdf'].'" target="_blank">Ir al PDF</a> &nbsp;  &nbsp; &nbsp;<a href="'.$urlP.$row['jpg'].'.jpg" target="_blank">Ir a la Imagen</a> &nbsp;  &nbsp; &nbsp; Link: <span style="color: blue;text-decoration: underline;">'.$urlP.$row['pdf'].'</span>'; 
            }
            else
            {
              $mensaje .= '<a href="'.$link.'" target="_blank">Ir a la Nota</a> &nbsp;  &nbsp; &nbsp; Link: <span style="color: blue;text-decoration: underline;">'.$link.'</span>';
            } 
            ...
            $notasexistentes[]=$row['idEditorial'];
        }        
      }
  }else{
//      $mensaje.='
...
function tablaContador($contador,$medios,$contadorWeb,$mediosWeb,$actor,&$Duplicados)
{
  $notas = 0;
  $periodicos = 0;
  ...
  $periodicos = mysql_fetch_row(mysql_query($medios));

  $notasWeb = mysql_num_rows(mysql_query($contadorWeb));
  $periodicosWeb = mysql_fetch_row(mysql_query($mediosWeb));

  if(($notas!=0 && $periodicos[0]!=0) || ($notasWeb!=0 && $periodicosWeb[0]!=0))
  {
    $mensaje = "<tr>";
      $mensaje .= "<td align='center'>".$actor."</td>";
      $mensaje .="<td align='center'>".$notas."</td>";
      $mensaje .="<td align='center'>".$periodicos[0]."</td>";
      $mensaje .="<td align='center'>".$notasWeb."</td>";
      $mensaje .="<td align='center'>".$periodicosWeb[0]."</td>";
    $mensaje .="</tr>";
  ...
  {
    $mensaje .="<td align='center'></td><td align='center'></td><td align='center'></td><td align='center'></td>";
  }
  return $mensaje;
...
<table width="50%" align="center" cellspacing="0" border="0" style="font-size: 12px;border: solid 1px gray;">
 <tr>
    <td colspan="5" align="center"><img src="'.$urlP.'/external/services/mail/inee/inee.jpg"style="width: 400px;"></td>
 </tr>
  <tr style="background-color: gray; color: white;">
      <td  align="center" >Tema</td>
      <td  align="center" >Notas</td>
      <td  align="center" >No. Medios</td>
      <td  align="center" >Notas Web</td>
      <td  align="center" >No. Medios Web</td>
  </tr>';
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"INEE",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Funcionarios",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Reforma Educativa",$idDuplicados);
...
//echo $qryContador."<br>".$qryMedios."<br>".$qryContadorWeb."<br>".$qryMediosWeb."<br>";
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Sistema Educativo Nacional (SEN)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Sistema Nacional de Evaluación Educativa (SNEE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Política Nacional de Evaluación Educativa (PNEE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Servicio Profesional Docente (SPD)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"PRUEBA",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Evaluación educativa / Evaluación de la educación",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Conferencia del Sistema Nacional de Evaluación Educativa",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Consejo Social Consultivo de Evaluacion de la Educación (CONSCEE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Consejo de Vinculación con las Entidades Federativas (CONVIE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Consejo Pedagógico de Evaluación Educativa (CONPEE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Consejos Técnicos Especializados (CONTE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Secretaría de Educación Pública (SEP)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Sindicato Nacional de Trabajadores de la Educación (SNTE)",$idDuplicados);
...
$mensaje .= tablaContador($qryContador,$qryMedios,$qryContadorWeb,$qryMediosWeb,"Coordinadora Nacional de Trabajadores de la Educacion (CNTE)",$idDuplicados);
...
$mensaje .='
<div align="center">
    <img src="'.$urlP.'/external/services/mail/inee/graficaINEE.png" style="width: 500px;">
 </div>';
