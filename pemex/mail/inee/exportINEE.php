...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 2:
             $tema="COLUMNAS POLÍTICAS";$subtema=" ";
        ...
        case 5:
            ...
            break;
        case 6:
             $tema=" Funcionarios ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break; 
        case 7:
             $tema="Reforma Educativa  ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 8:
             $tema=" SEN ";$subtema=" ";
            ...
            break;   
        case 9:
             $tema=utf8_decode("SNEE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 10:
             $tema=utf8_decode("PNEE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 11:
             $tema=utf8_decode("SPD");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 12:
             $tema="PRUEBA";$subtema=" ";
            ...
            break;         
        case 13:
             $tema="EVALUACIÓN EDUCATIVA/EVALUACIÓN DE LA EDUCACIÓN";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 14:
             $tema=utf8_decode("CONFERENCIA DEL SISTEMA NACIONAL DE EVALUACIÓN EDUCATIVA ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 15:
             $tema=utf8_decode("CONSCEE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 16:
             $tema=utf8_decode("CONVIE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 17:
             $tema=utf8_decode("CONPEE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 18:
             $tema=utf8_decode("CONTE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 19:
             $tema=utf8_decode("SEP");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 20:
             $tema=utf8_decode("SNTE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 21:
             $tema=utf8_decode("CNTE");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
}
...
require '../conexion.php';
    ...
    {
        echo "<script>alert('No se encuentran Resultados de ".($tema)."$subtema');</script>";//.$query;
    }
}
