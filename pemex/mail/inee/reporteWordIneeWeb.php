        ...
        while ($row1 = mysql_fetch_array($resultTitular))
        {
          ...
          switch($Periodico)
          {
            ...
            default:
              ...
              $section->addLink($Encabezado, "\"".utf8_decode($Per)."\" ".(utf8_decode($Seccion)=="Error"?"":utf8_decode($Seccion))." ".$Fecha,'estiloLink2', 'pStyle2');
              $section->addTextBreak(1);            
            break;
          }
        }
...
$section->addPageBreak();
    ...
    */
    ...
    try {
        ...
        $objWriter->save("ResumenINEEWeb.docx");
        chmod("ResumenINEEWeb.docx", 0777);
