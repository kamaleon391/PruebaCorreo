...
<html lang="es">
  ...
  <body><style>body{font-family: Arial Narrow;}</style>
...
//$mensaje .= recuperaDatosWEB($qryINEEWEB, $titulo = "", $buscar );
...
WHERE
  p.idPeriodico=n.Periodico AND
  p.idPeriodico=o.periodico AND
  p.idPeriodico not in (50,32,51) AND
  s.idSeccion=n.Seccion AND
  c.idCategoria=n.Categoria AND
  p.Estado=e.idEstado AND
  n.Categoria<>80 AND
...
//$mensaje .= recuperaDatos($qryReformaEducativaLINKS, $titulo = "Reforma Educativa", $buscar );
/*
...
//$mensaje .= recuperaDatosWEB($qryReformaEducativaWEB, $titulo = "", $buscar );
*/
...
ORDER BY o.posicion";
//$mensaje .= recuperaDatos($qrySENLINKS, $titulo = "SEN - Sistema Educativo Nacional", $buscar );
...
//$mensaje .= recuperaDatosWEB($qrySEN, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qrySNEELINKS, $titulo = "SNEE - Sistema Nacional de Evaluación Educativa", $buscar );
...
//$mensaje .= recuperaDatosWEB($qrySNEEWEB, $titulo = "", $buscar );
...
ORDER BY o.posicion";
//$mensaje .= recuperaDatos($qryPNEELINKS, $titulo = "SNEE - Sistema Nacional de Evaluación Educativa", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryPNEEWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qrySPDLINKS, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatosWEB($qrySPDWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryPRUEBA,$qryPRUEBALINKS, $titulo = "INEE - PRUEBA", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryPRUEBAWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryEvaluacionLINKS,$qryEvaluacionLINKS, $titulo = "Evaluación de la Educación", $buscar );
...
//$mensaje .= recuperaDatos($qryConferenciaLINKS,$qryConferenciaLINKS, $titulo = "Conferencia del Sistema Nacional de Evaluacion Educativa", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryCONFERENCIAWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryConsejoLINKS,$qryConsejoLINKS, $titulo = "Consejo Social Consultivo de Evaluacion de la Educacion", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryConsejoWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryConsejoVinculacionLINKS,$qryConsejoVinculacionLINKS, $titulo = "Consejo de Vinculacion con las Entidades Federativas", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryVinculacionWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryConsejoPedagogicoLINKS,$qryConsejoPedagogicoLINKS, $titulo = "Consejo Pedagogico de Evaluacion Educativa", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryPedagogicoWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qryTecnicosLINKS,$qryTecnicosLINKS, $titulo = "Consejos Tecnicos Especializados", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryTecnicosWEB, $titulo = "", $buscar );
...
//$mensaje .= recuperaDatos($qrySEPLINKS,$qrySEPLINKS, $titulo = "SEP", $buscar );
...
//$mensaje .= recuperaDatosWEB($qrySEPWeb, $titulo = "", $buscar );
...
ORDER BY o.posicion";
//$mensaje .= recuperaDatos($qrySNTELINKS,$qrySNTELINKS, $titulo = "SNTE", $buscar );
...
//$mensaje .= recuperaDatosWEB($qrySNTEWEB, $titulo = "", $buscar );
...
ORDER BY o.posicion";
//$mensaje .= recuperaDatos($qryCNTELINKS,$qryCNTELINKS, $titulo = "CNTE", $buscar );
...
//$mensaje .= recuperaDatosWEB($qryCNTEWEB, $titulo = "", $buscar );
...
function recuperaDatos($sql, $titulo, $buscar = array())
{
    ...
    $mensaje.='
            <tr>
                <th colspan="3" style="font-family: Arial Narrow;text-align:center; background:#FFFFFF; color:#B30000; height: 30px; font-size: 19px;text-transform: uppercase;">'.utf8_decode($titulo).'</th>
            </tr>';
    $result =  mysql_query($sql);
    if(mysql_affected_rows() > 0)
    {
        while ( $row = mysql_fetch_array($result) ) 
        {
            ...
            $mensaje .='
                ...
                <tr>
                  <td colspan="3">
                     '.recorte($row['idEditorial']).'<span style="font-size:16px;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href="http://187.247.253.5/external/testigos/visor.php?p='.base64_encode($row['Periodico'])."&f=".base64_encode($row['Fecha'])."&pag=".base64_encode($row['NumeroPagina']).'" target="_blank">Ir al PDF</a></span> &nbsp;  &nbsp; &nbsp;<span style="font-size:16px;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href="'.$urlP.$row['jpg'].'.jpg" target="_blank">Ir a la Imagen</a></span> &nbsp;  &nbsp; &nbsp; Link: <span style="font-size:16px;color: blue;text-decoration: underline;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href='.$urlP.$row['pdf'].' target="_blank">'.$urlP.$row['pdf'].'</a></span>
                  </td>
                </tr>
    ...
    if(mysql_affected_rows() > 0)
    {
        ...
        while ( $row = mysql_fetch_array($result) ) 
        {
          ...
          $mensaje .='
                <tr>
                  <td colspan="3">
                    '.recorte($row['idEditorial']).'<span style="font-size:14px;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href="'.$urlP.$row['pdf'].'" target="_blank">Ir al PDF</a></span> &nbsp;  &nbsp; &nbsp;<span style="font-size:16px;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href="'.$urlP.$row['jpg'].'.jpg" target="_blank">Ir a la Imagen</a></span> &nbsp;  &nbsp; &nbsp; Link: <span style="font-size:16px;color: blue;text-decoration: underline;"><a style="font-family: Arial Narrow;font-weight: bold;color: rgb(0, 110, 207);" href='.$urlP.$row['pdf'].' target="_blank">'.$urlP.$row['pdf'].'</a></span>
                  </td>
                </tr>'; 
        }        
