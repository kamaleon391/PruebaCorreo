...
$report = new WebReport(date('Y-m-d'), 'http://187.247.253.5/external/services/mail/pizza/ccim.png', 'http://187.247.253.5/external/services/mail/pizza/ccim.png', ['4576','4577','4578','4580']);
...
//echo $report->message;
 ...
 /* PREPARA OBJETO DE ENVIO...*/
  ...
  $data   = array(
    "to" => array(
        'oscar.santiago@camaraitaliana.com.mx'  =>  'oscar.santiago@camaraitaliana.com.mx',
    ...
    "subject" => "Camara de Comercio Italiana Monitoreo de Medios",
    "html" => utf8_encode($report->message),
    "headers" => array("Content-Type"=> "text/html; charset=UTF-8", "X-Mailin-Tag" => "Impresos-Camara de Comercio Italiana")
);
