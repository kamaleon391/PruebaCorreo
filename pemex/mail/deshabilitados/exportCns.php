...
if(isset($_GET['p']) && isset($_GET['f']) && isset($_GET['e'])){
    include './querysCns.php';
       //$fecha=$_GET['f'];
       //$estado=base64_decode($_GET['e']);
       //$valor=base64_decode($_GET['p']);
       $estado=base64_decode(base64_decode($_GET['e']));
       $valor=base64_decode(base64_decode($_GET['p'])); 
       $fecha=base64_decode(base64_decode($_GET['f']));
       
       $query=query($valor, $fecha,$estado);
      //$tabla=defineFecha($fecha);
      
    switch ($valor) {
        case 1: // PRIMERAS PLANAS
             $tema="PRIMERAS PLANAS";$subtema=" | ".$estado;
             ArmaPdf($query,$tema,$subtema);
            break;
        case 2:
             $tema="COLUMNAS";$subtema=" | ";
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema=utf8_decode("MONTE ALEJANDRO RUBIDO | ");$subtema=$estado;
             ArmaPdf($query,$tema,$subtema);
            break;
        case 6:
             $tema=utf8_decode("GOBIERNO FEDERAL | ");$subtema=$estado;
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("SEGURIDAD Y JUSTICIA | ");$subtema=$estado;
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("GOBIERNO ESTATAL | ");$subtema=$estado;
             ArmaPdf($query,$tema,$subtema);
            break;
}
...
require '../php/conexion.php';
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                      ...
                      $pdf->Text(10,156,strtoupper($tema.$subtema));
                      $pdf->SetFont("arial", "B", 13);
                      $pdf->setTextColor(255,255,255);
                      $pdf->Text(10,23,"test");

                      $pdf->Image('cns/Logo.png',5,100,100); 
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(135,8,$tema.$subtema);
                       $pdf->Image('cns/logopdf2.png',5,340,30); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('cns/logopdf2.png',5,100,100); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
