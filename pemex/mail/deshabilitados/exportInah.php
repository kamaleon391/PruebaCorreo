...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema=("MARÍA TERESA FRANCO");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;
        case 6:
             $tema=("INAH");$subtema=" ";
            ...
            break; 
        case 7:
             $tema="CONACULTA ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break; 
        case 8:
             $tema=("CENTROS PREHISPÁNICOS ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break; 
        case 9:
             $tema=("CENTROS HISTÓRICOS");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 10:
             $tema="MUSEOS ";$subtema=" ";
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('inah/Logo.png',5,90,80); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$tema);
                       $pdf->Image('inah/Logo.png',5,330,40); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
        ...
        //
            ...
            for($j=0;$j<sizeof($periodico);$j++){
               if(file_exists($variable[$j])){
                     ...
                     $pdf->setTextColor();
                     $pdf->Text(182,13,date('Y-m-d'));  
                     $pdf->Image('inah/Logo.png',5,340,50); 
                     //$pdf->WriteHTML($html);
                     //$pdf->addPage('L'); //landscape
