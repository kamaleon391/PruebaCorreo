...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 6:
            ...
            break; 
        case 7:
             $tema=utf8_decode("SUBSECRETARÍAS ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 8:
        ...
        case 9:
            ...
            break;   
        case 10:
             $tema="AGRICULTURA";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 11:
             $tema=utf8_decode("GANADERÍA");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
        case 12:
             $tema="PESCA";$subtema=" ";
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('sagarpa/Logo.png',5,100,100); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->Cell(0,0,  ($tema).  ($subtema),0,'','R');
                       $pdf->Image('sagarpa/Logo.png',5,340,30); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
