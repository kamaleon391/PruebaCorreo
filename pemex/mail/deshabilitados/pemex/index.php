...
'>
  <tr>
    <td width='3%'>&nbsp;</td>
    <td colspan='5'><img src='http://200.53.59.226/services/APP/lib/pemex/logo.png' style='width:100px;'></td>
    <td width='3%'>&nbsp;</td>
  </tr>
 <tr>
  <td>&nbsp;</td>
 ...
 <tr>
  ...
  <tr >
    ...
    <td width='49%' style='border-bottom: 1pt solid rgb(230, 230, 230);'>".utf8_decode("PEMEX")."</td>
    <td width='15%'  style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://200.53.59.226/services/APP/lib/exportPemex.php?p=".base64_encode(base64_encode('1'))."&f=$fecha'>REPORTE</a></td>
...
//PEMEX
$mail->AddBCC("sergio.sansores@pemex.com");

$mail->FromName = "MONITOREO DE PRENSA PEMEX";
 
$mail->Subject  = "".date("Y-m-d");  
$mail->WordWrap = 50;
