...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema=" MERCEDES JUAN LÓPEZ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;
        case 6:
             $tema=" SSA ";$subtema=" ";
            ...
            break; 
        case 7:
             $tema="ZACATECAS | ";$subtema="PRESIDENTE DE LA REPÚBLICA";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 8:
             $tema="ZACATECAS | ";$subtema="GOBERNADOR";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 9:
             $tema="ZACATECAS | ";$subtema="SECRETARÍA DE SALUD";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 10:
             $tema="SAN LUIS POTOSÍ | ";$subtema="PRESIDENTE DE LA REPÚBLICA";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 11:
             $tema="SAN LUIS POTOSÍ | ";$subtema="GOBERNADOR";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 12:
             $tema="SAN LUIS POTOSÍ | ";$subtema="SECRETARÍA DE SALUD";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 13:
             $tema="DURANGO | ";$subtema="PRESIDENTE DE LA REPÚBLICA";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 14:
             $tema="DURANGO | ";$subtema="GOBERNADOR";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 15:
             $tema="DURANGO | ";$subtema="SECRETARÍA DE SALUD";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 16:
             $tema="MICHOACÁN | ";$subtema="PRESIDENTE DE LA REPÚBLICA";
             ArmaPdf($query,$tema,$subtema);                      
            break;    
        case 17:
             $tema="MICHOACÁN | ";$subtema="GOBERNADOR";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 18:
             $tema="MICHOACÁN | ";$subtema="SECRETARÍA DE SALUD";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
}
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,156,  utf8_decode($tema)." ".utf8_decode($subtema));
                      $pdf->SetFont("arial", "B", 13);
                      $pdf->setTextColor(255,255,255);
                      $pdf->Text(10,23,"test");

                       $pdf->Image('salud/logopdf.png',5,90,100); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->SetY(8);
                      $pdf->Cell(0,0,  utf8_decode($tema).  utf8_decode($subtema),0,'','R');
                       $pdf->Image('salud/logopdf.png',5,340,30); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
        ...
        $pdf->Output(utf8_decode($tema)." ".utf8_decode($subtema).".pdf", 'D');   
    }else{
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('salud/logopdf.png',5,100,100); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
