...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {  
        ...
        case 5:
             $tema=utf8_decode("Secretaría Turismo ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);                      
        break;    
    
        case 6:
             $tema="Fonatur ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);                      
        break;    
    
        case 7:
             $tema="Tianguis Turistico ";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);                      
        break;   //Hoteles 
        ...
        case 10: // PRIMERAS PLANAS
             $tema="Delegaciones";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
            break;
        case 11:
             $tema="Desarrollos Turisticos";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
            break;
        case 12:
             $tema="Hoteles";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
            break;
        case 13:
             $tema="Restaurantes";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
            break;
        case 14:
             $tema=utf8_decode("Pro México");$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
            break;
        case 15:
             $tema="Varios";$subtema=" ";
        ...
        case 17:
             $tema="Claudia Ruiz Massieu";$subtema=" ";
             ArmaPdf($query,$tema,$subtema,$cir);
        break;
        default:
}
...
function ArmaPdf($query,$tema,$subtema)
{
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->Image('../img/secretarias/fonatur.png',5,100,140); 
        ...
        for($j=0;$j<sizeof($periodico);$j++)
        {
            if(file_exists($variable[$j]))
            {
                ...
                $pdf->setTextColor();
                $pdf->Text(170,8,$tema);
                $pdf->Image('../img/secretarias/fonatur.png',5,340,50);
