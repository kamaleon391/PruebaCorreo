...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;  
        case 5:
             $tema="Jorge Lopez Portillo";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;
        case 6:
             $tema="ESSA ";$subtema=" ";
        ...
        case 7:
            ...
            break;    
        case 8:
             $tema="Idelfonso Guajardo";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 9:
             $tema="Secretaria de Economia";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;   
        case 10:
             $tema="Secretaria de Hacienda";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
            break;         
}
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                       ...
                       $pdf->Image('t14/logoPDF.png',5,100,100); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$tema);
                       $pdf->Image('t14/logoPDF.png',5,340,30); 
                     /*   $pdf->SetFont("arial", "", 9);
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$subtema);  
         */
       ...
       $pdf->addPage();
        ...
        $pdf->Image('t14/logoPDF.png',5,10,80);
        $pdf->Output($tema.$subtema.".pdf", 'D');    
    }
