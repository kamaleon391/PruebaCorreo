...
//Query Contador de Notas Carlos Lomelí Bolaños
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
      ...
      n.Activo = 1 AND
        fecha = CURDATE() AND (
  Texto like '%Carlos Lomelí Bolaños%' OR
  Texto like '%Lomelí Bolaños%' OR

  Titulo like '%Carlos Lomelí Bolaños%' OR
  Titulo like '%Lomelí Bolaños%' OR

  Encabezado like '%Carlos Lomelí Bolaños%' OR
  Encabezado like '%Lomelí Bolaños%' OR

  PieFoto like '%Carlos Lomelí Bolaños%' OR
  PieFoto like '%Lomelí Bolaños%'
)";
...
//Query Contador de Notas Miguel Castro-Enrique Alfaro
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
//Query Contador de Notas Miguel Castro-Carlos Lomeli
 $qryContador = "SELECT
     COUNT(*) AS 'Total'
      FROM
        noticiasDia n,
...
$mensaje .='<br>
<tr>
    <td colspan="3" align="center"><img src="'.$urlP.'/external/services/mail/candidatos2018/graficaMCR.png" style="width: 500px;"></td>
 </tr>';


//QUERY Miguel Castro Reynoso
$qryReynoso="SELECT
      n.Cutted,
...
$mensaje .= recuperaDatos($qryReynoso, $titulo = "Miguel Castro Reynoso", $buscar );
...
$mensaje .= recuperaDatos($qrylomeli, $titulo = "Carlos Lomelí Bolaños", $buscar );
...
$mensaje .= recuperaDatos($qryVillanuevaAlfaro, $titulo = "MCR-EAR", $buscar );



//QUERY Villanueva-Petersen
$qryReynosoBolanos = "SELECT
n.cutted,
  n.Periodico as idPeriodico,
  n.idEditorial,
  n.Titulo,
...
$mensaje .= recuperaDatos($qryReynosoBolanos, $titulo = "MCR-CLB", $buscar );
