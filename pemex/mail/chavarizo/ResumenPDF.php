...
class PDF extends FPDI
{
    ...
    {
        // Logo
        $this->Image('/var/www/external/services/mail/chavarizo/prijalisco.png',80,10,40);
        //color negro
        $this->SetTextColor(0);
        // Arial bold 15
...
function titulo($opc)
{
    ...
    {
        case 1:
            $titulo=utf8_decode("Salvador Rizo Castelo");
        break;
        case 2:
            $titulo=utf8_decode("Pablo Lemus Navarro");
        break;
        case 3:
            $titulo=utf8_decode("Guillermo Martínez Mora");
        break;
        case 4:
            $titulo=utf8_decode("Zapopan");
        break;
    }
    return $titulo;
}
