...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/jalisco/jaliscoWord/listaWord.php'>REPORTE JALISCO WORD</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "gacomunicacion2017plus";   
    ...
    $mail->Subject  = " Reporte Jalisco - ".Date('Y-m-d');
    ...
    $mail->AddBCC('cmandujanof@gmail.com');     
    $mail->AddBCC('cdgoficina@gmail.com');        
    $mail->AddBCC('lexroam01@hotmail.com');       
    $mail->AddBCC('mmaqueo66@gmail.com');           
    $mail->AddBCC('cdg.jal2018@gmail.com');
    //----------------------------------------------------------------
    ...
    $wordReporte = "/var/www/external/testigos/Jalisco/ReportesWord/".date('m')."/Reporte Jalisco - ".DATE('Y-m-d').".docx";

    if(file_exists( $wordReporte ))
    {
      $mail->AddAttachment( $wordReporte , "Reporte Jalisco - ".DATE('Y-m-d').".docx");
    } 
