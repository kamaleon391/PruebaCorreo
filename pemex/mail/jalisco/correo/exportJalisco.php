...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        case 1: // PRIMERAS PLANAS
             $tema="PRIMERAS PLANAS - CDMX";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 2:
             $tema="COLUMNAS POLITICAS - CDMX";$subtema=" ";
             ArmaPdfColumnas($query,$tema,$subtema);
            break;
        case 3:
             $tema="COLUMNAS FINANCIERAS - CDMX";$subtema=" ";
             ArmaPdfColumnas($query,$tema,$subtema);
            break;
        case 4:
             $tema="CARTONES - CDMX";$subtema=" ";
             ArmaPdfColumnas($query,$tema,$subtema);
        break;//Cartones  
        case 5: // PRIMERAS PLANAS
            ...
            break;
        case 6:
             $tema="COLUMNAS - Jalisco";$subtema=" ";
             ArmaPdfColumnas($query,$tema,$subtema);
        break;
        case 7:
             $tema="CARTONES - Jalisco";$subtema=" ";
             ArmaPdfColumnas($query,$tema,$subtema);
        break;//Cartones  
        case 8:
             $tema="Gobernador, parte 1"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete   
        case 9:
             $tema="Gobernador, parte 2"; $subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 10:
             $tema= "Gobernador, parte 3" ; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;         
        case 11:
             $tema="Dependencias, parte 1";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;  
        case 12:
             $tema="Dependencias, parte 2";$subtema="";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 13:
             $tema="Dependencias, parte 3";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 14:
             $tema="Jalisco, parte 1"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 15:
             $tema="Jalisco, parte 2"; $subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break; 
        case 16:
             $tema="Jalisco, parte 3";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;  
    }
    ...
    $pdf->Output($tema.$subtema.".pdf", 'D'); 
      ...
      /* 
       $pdf->addPage();
        ...
        $pdf->Image('salud/Logo.jpg',5,10,80);
