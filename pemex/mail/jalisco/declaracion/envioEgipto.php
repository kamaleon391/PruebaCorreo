...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/jalisco/declaracion/listaTestigosEgipto.php'>REPORTE DE DECLARACIONES EGIPTO</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
//    $mail->AddBCC("edgarh@gacomunicacion.com");
    ...
    $reporte = "/var/www/external/testigos/Jalisco/declaracion/df/Reporte Declaraciones Egipto - DF - ".DATE('Y-m-d').".pdf";

    if( file_exists( $reporte ) )
    {
      $mail->AddAttachment( $reporte , "Reporte Declaraciones Egipto - ".DATE('Y-m-d').".pdf");
    } 
