<?php
  ...
  if(isset($_GET['doc']))
  {
    ...
    switch($doc)
      {
          case 1:
            $dir = "Portadas"; //ruta actual
          break;

          case 2:
            $dir = "Notas"; //ruta actual
          break;

          case 3:
            $dir = "Columnas"; //ruta actual
          break;

          case 4:
            $dir = "Cartones"; //ruta actual
          break;
		...
		<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px; text-align: center;' align='center' >
		  ...
		  <tr>
		    <td colspan='8' align='center'><span style='font-weight: bold; font-size: 20px;'>MONITOREO DE PRENSA - {$dir}</span></td>
		  </tr>
		  <tr>
		    <td>&nbsp;</td>
		    <td>&nbsp;</td>
		  ...
		  <tr>
		    <td>&nbsp;</td>
		    <td>Testigos Incidente en Egipto</td>
		    <td>&nbsp;</td>
		    <td>&nbsp;</td>
		    <td>&nbsp;</td>
		    <td>&nbsp;</td>
    ...
    $directorio = opendir("/var/www/external/testigos/Jalisco/TestigosChapo/".$dir."/"); //ruta actual
    ...
    while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
    {
        if (!is_dir($archivo) && $archivo[0]!=".")//verificamos si es o no un directorio
        {
          $mensaje.="<tr>
            <td>&nbsp;</td>
              <td colspan='5'><a href='http://187.247.253.5/external/testigos/Jalisco/TestigosChapo/".$dir."/".$archivo."'><img src='icon.png' width='25' height='25'>".$archivo."</a><br><br></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>";
        }
