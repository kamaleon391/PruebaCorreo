...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/jalisco/egipto/listaTestigosEgipto.php'>REPORTE INCIDENTE EN EGIPTO </a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "Gacomunicacion#@2014";   
    ...
    $mail->Subject  = " Reporte Incidente Egipto - ".Date('Y-m-d');
    ...
    $mail->AddBCC("badillo.oma@gmail.com");  
    ...
    $reporte = "/var/www/external/testigos/Jalisco/Egipto/df/Reporte Egipto - DF - ".DATE('Y-m-d').".pdf";

    if( file_exists( $reporte ) )
    {
      $mail->AddAttachment( $reporte , "Reporte Incidente Egipto - ".DATE('Y-m-d').".pdf");
    } 
