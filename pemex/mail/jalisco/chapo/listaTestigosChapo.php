<?php
    ...
    $directorio = opendir("/var/www/external/testigos/Jalisco/ChapoGuzman/"); //ruta actual
    ...
    while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
    {
        if (!is_dir($archivo) && $archivo[0]!=".")//verificamos si es o no un directorio
        {
          $mensaje.="<tr>
            <td>&nbsp;</td>
              <td colspan='5'><a href='http://187.247.253.5/external/testigos/Jalisco/ChapoGuzman/".$archivo."'><img src='icon.png' width='25' height='25'>".$archivo."</a><br><br></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>";
        }
