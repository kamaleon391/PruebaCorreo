...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/jalisco/cocos/listaTestigosCocos.php'>REPORTE ROBERTO LOPEZ RIVERA</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
/********************  CODIGO COMENTADO POR ABUSO DE ENVIOS GA  **********************    
   ...
   ********************************************************************************************/
    ...
    $mail->Subject  = " Reporte Roberto López Rivera - ".Date('Y-m-d');
    ...
    $mail->AddBCC("creyes@gacomunicacion.com");
    ...
    $_reporte = "/var/www/external/testigos/Jalisco/cocos/Reporte Roberto Lopez - ".DATE('Y-m-d').".pdf";

    if(file_exists( $_reporte ))
    {
      $mail->AddAttachment( $_reporte , "Reporte Roberto Lopez - ".DATE('Y-m-d').".pdf");
    } 
