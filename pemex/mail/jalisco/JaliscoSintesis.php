...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td colspan='8' align='center'><span style='font-weight: bold; font-size: 20px;'>MONITOREO DE PRENSA SINTESIS ESTATAL</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/testigos/Jalisco/Sintesis.php?d=0'>REPORTE</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
$mail->FromName = "SINTESIS ESTATAL";
$mail->Subject  = " Gobierno Del Estado de Jalisco ".Date('Y-m-d');
//----------------------------------------------------------------
/*
$mail->AddBCC("oscarsamuel.h@gmail.com");                                                           // Mes
...
$mail->AddBCC("luisenriquerh@hotmail.com");
$mail->AddBCC("blanca.paz88@gmail.com");
$mail->AddBCC("dianalorenarr@outlook.es");
