...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/nafinsa/columnas/listaTestigos.php'>Columnas Nafinsa</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "Gacomunicacion#@2014";   
    ...
    $mail->Subject  = " Columnas Nafinsa - ".Date('Y-m-d');
    ...
    $chapoReporte = "/var/www/external/testigos/nafinsa/columnas/".DATE('Y-m-d')."/compendio/".DATE('Y-m-d').".pdf";
