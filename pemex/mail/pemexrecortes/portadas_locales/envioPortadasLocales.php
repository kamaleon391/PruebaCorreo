...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail//nafinsa/portadas_locales/listaTestigos.php'>Portadas Locales CDMX</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "Gacomunicacion#@2014";   
    ...
    $mail->Subject  = " Portadas Locales CDMX- ".Date('Y-m-d');
    ...
    $chapoReporte = "/var/www/external/testigos//nafinsa/portadasLocales/portadasLocales-".DATE('Y-m-d').".pdf";

    if(file_exists( $chapoReporte ))
    {
      $mail->AddAttachment( $chapoReporte , "portadasLocales-".DATE('Y-m-d').".pdf");
    } 
