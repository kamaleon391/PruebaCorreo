...
WHERE
    ...
    n.Periodico in (32,50,51,53,59,47,52,97,247,302,319,325,346,1968) AND
    p.idPeriodico=o.periodico AND
    s.idSeccion=n.Seccion AND
    c.idCategoria=n.Categoria AND
    c.idCategoria in(3,137) AND
    n.Activo = 1 AND
    n.Fecha = CURDATE()
GROUP BY n.NumeroPagina,p.idPeriodico
ORDER BY c.idCategoria,o.posicion";
...
function creaPDF( $query , $fecha){
    ...
    */
    ...
    if( !empty($pdfs) ){
        ...
        $nombre="/var/www/external/testigos/pemex/portadas/portadas-".$fecha.".pdf";
        $pdf->Output($nombre, 'F');
