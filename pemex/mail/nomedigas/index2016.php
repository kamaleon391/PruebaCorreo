...
$report = new WebReport(date('Y-m-d'), 'http://187.247.253.5/external/services/mail/nomedigas/NomeDigas.jpg', 'http://187.247.253.5/external/services/mail/nomedigas/NomeDigas.jpg', ['4445','4446','4447']);
...
//echo $report->message;
 ...
 /* PREPARA OBJETO DE ENVIO...*/
  ...
  $data   = array(
    ...
    "subject" => "#NomeDigasGuapa Monitoreo de Medios",
    "html" => utf8_encode($report->message),
    "headers" => array("Content-Type"=> "text/html; charset=UTF-8", "X-Mailin-Tag" => "Impresos-NomeDigasGuapa")
);
