...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor) {
        ...
        case 10:
            ...
            break;
        case 11:
             $tema="Luis Enrique Miranda";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);                      
             break;           
}
    ...
    if(mysql_affected_rows()>0)
    {
        ...
        $pdf->addPage();
                    ...
                    //rectangulo GRis ABAJO
                      ...
                      $pdf->Text(10,23,"test");
                      $pdf->Image('liconsa/logopdf2.png',5,100,100);
        ...
        for($j=0;$j<sizeof($periodico);$j++){
                if(file_exists($variable[$j])){
                      ...
                      $pdf->setTextColor();
                      $pdf->Text(170,8,$tema);
                       $pdf->Image('liconsa/logopdf2.png',5,340,30); 
        ...
        $pdf->Output($tema.$subtema.Date('Y-m-d').".pdf", 'D');   
    }else{       
