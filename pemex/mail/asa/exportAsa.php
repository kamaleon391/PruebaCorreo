...
if (isset($_GET['p']) && isset($_GET['f'])) {
    include 'queriesAsa.php';

    $valor = base64_decode(base64_decode($_GET['p']));
    if( $valor == 5 ){
        $query = query($valor, $_GET['f'], $_GET['i'] );
    } else {
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
            $tema = utf8_decode("Presidencia de la República");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema );
            break;
        case 6:
            $tema = utf8_decode("Información Institucional");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 7:
            $tema = utf8_decode("Red de Aeropuertos y Servicios Auxiliares");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 8: //
            $tema = utf8_decode("Nuevo Aeropuerto Internacional de la Ciudad de México");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 9: //
            $tema = utf8_decode("Grupo Aeroportuario de la Ciudad de México");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 10: //
            $tema = utf8_decode("Dirección General de Aeronautica Civil");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 11: //
            $tema = utf8_decode("Aeropuertos");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 12: // 
            $tema = utf8_decode("Aerolíneas");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 13: // 
            $tema = utf8_decode("Sector Aeronáutico y Aeroespacial");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 14: // 
            $tema = utf8_decode("Secretaría de Gobernación");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 15: // 
            $tema = utf8_decode("Secretaría de Comunicaciones y Transportes");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 16: // 
            $tema = utf8_decode("Secretaría de Turismo");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
        case 17: // 
            $tema = utf8_decode("Combustibles");
            $subtema = " ";
            ArmaPdf($query, $tema, $subtema);
            break;
    }
