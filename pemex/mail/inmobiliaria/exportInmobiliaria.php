...
if(isset($_GET['p']) && isset($_GET['f'])){
    include './querysInmobiliaria.php';
    ...
    switch ($valor) {
        ...
        case 4:
            ...
            break;
        case 5:
             $tema="Be Grand";$subtema=" Parte 1";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 6:
             $tema=" Be Grand - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
             $tema=utf8_decode("ABILIA ");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 8:
             $tema=utf8_decode("ABILIA - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 9:
             $tema=utf8_decode("Inmobiliario");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 10:
             $tema=utf8_decode("Inmobiliario - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 11:
             $tema=utf8_decode("Desrrolladoras de vivienda");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 12:
             $tema="Desrrolladoras de vivienda - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;
