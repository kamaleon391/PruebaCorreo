...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        break;
        case 3:
             $tema="".utf8_decode("Ricardo Barroso Agramont - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 4:
             $tema=utf8_decode("Candidato PAN - DF");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Cartones  
        case 5:
             $tema="Candidato PRD - DF";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//PRD/PT           
        case 6:
        ...
        //Estados
        case 12:
             $tema="".utf8_decode("Ricardo Barroso Agramont - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;
        case 13:
             $tema=utf8_decode("Candidato PAN - Estados");$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Cartones  
        case 14:
             $tema="Candidato PRD - Estados";$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
        break;//PRD/PT           
        case 15:
