...
if(isset($_GET['p']) && isset($_GET['f'])){
    ...
    switch ($valor){
        ...
        case 4:
            ...
            break;//Cartones
        case 5:
             $tema="PROFECO - ". $varEstados[$estado];$subtema=" ";
             ArmaPdf($query,$tema,$subtema);
            break;//Navarrete
        case 6:
             $tema="PRCURADOR - ". $varEstados[$estado]; $subtema="  ";
             ArmaPdf($query,$tema,$subtema);
            break;
        case 7:
