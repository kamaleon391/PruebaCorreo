<?php
    ...
    while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
    {
        ...
        {*/
          $mensaje.="<tr>
            <td>&nbsp;</td>
              <td colspan='5'><a href='http://187.247.253.5/external/testigos/nafinsa/infoGeneral/".Date('Y-m-d')."/compendio/".Date('Y-m-d').".pdf'><img src='icon.png' width='25' height='25'>Informacion General-".Date('Y-m-d')."</a><br><br></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>";
        /*}
