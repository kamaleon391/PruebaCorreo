...
<table width= '500px;' border='0' cellspacing='0' style='border: #CCC solid;font-family: century gothic;font-size: 15px;-moz-border-radius: 7px;-webkit-border-radius: 7px;border-radius: 7px;' align='center' >
  <tr>
    <td colspan='8' style='background-color: rgb(252, 252, 252);' align='center'><img id='logoC' src='http://187.247.253.5/external/services/mail/nafinsa/logoNafinsa.jpg'  ></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan='5'><a href='http://187.247.253.5/external/services/mail/nafinsa/infoGeneral/listaTestigos.php'>Informacion General</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
*/  
  ...
  $mail->Password   = "Gacomunicacion#@2014";   
    ...
    $mail->Subject  = " Informacion General- ".Date('Y-m-d');

    //----------------------------------------------------------------
    
    /*$mail->AddBCC("clacruzperez@hotmail.com");
    $mail->AddBCC("ccruz@nafin.gob.mx");
    $mail->AddBCC("glopez@nafin.gob.mx");
    $mail->AddBCC("oortiz@gacomunicacion.com");
    
    //$mail->AddBCC("comandermaceda2000@gmail.com'");
    $mail->AddBcc('jesushbga@gmail.com');
    $mail->AddBcc('gaimpresos@gmail.com');
    $mail->AddBCC('ehb1703@icloud.com', 'Edgar Oswaldo Hernández Barajas');*/
    ...
    $chapoReporte = "/var/www/external/testigos/nafinsa/infoGeneral/".DATE('Y-m-d')."/compendio/".DATE('Y-m-d').".pdf";

    //if(file_exists( $chapoReporte ))
    //{
      //$mail->AddAttachment( $chapoReporte , "Cartones-".DATE('Y-m-d').".pdf");
    //} 
