...
$report = new WebReport(date('Y-m-d'), 'http://187.247.253.5/external/services/mail/tupperware/tupperware.jpg', 'http://187.247.253.5/external/services/mail/tupperware/tupperware.jpg', ['4461']);
...
//echo $report->message;
 ...
 /* PREPARA OBJETO DE ENVIO...*/
  ...
  $data   = array(
    ...
    "subject" => "TUPPERWARE Monitoreo de Medios",
    "html" => utf8_encode($report->message),
    "headers" => array("Content-Type"=> "text/html; charset=UTF-8", "X-Mailin-Tag" => "Impresos-TUPPERWARE")
);
