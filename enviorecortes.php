...
<table width='900px' align='center' cellspacing='0' border='0' style='font-size: 13px;border: solid 1px gray;'>
  ...
  <tr>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>Síntesis Completa</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>
      <a href='http://187.247.253.5/external/testigos/pemex/compendiocompleta/sistesis-".$fecha.".pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);'>
      <a href='http://187.247.253.5/external/testigos/pemex/dirgeneral/$fecha/compendio/$fecha.pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >
        <a href='http://187.247.253.5/external/testigos/pemex/pemex/$fecha/compendio/$fecha.pdf'>".('Clic Aquí')."</a></td>
  </tr>";
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >
        <a href='http://187.247.253.5/external/testigos/pemex/portadas/portadas-$fecha.pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >
        <a href='http://187.247.253.5/external/testigos/pemex/columnaspoliticas/$fecha/compendio/$fecha.pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";

  $mensaje .="
  <tr>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >Trascendidos</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >
        <a href='http://187.247.253.5/external/testigos/pemex/trascendidos/$fecha/compendio/$fecha.pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";
  ...
  <tr>
    ...
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >&nbsp;</td>
    <td style='border-bottom: 1pt solid rgb(230, 230, 230);' >
        <a href='http://187.247.253.5/external/testigos/pemex/cartones/$fecha/compendio/$fecha.pdf'>".('Clic Aquí')."</a>
    </td>
  </tr>";
...
function sendinblue($message){
    ...
    $data   = array(
        "to" => array(
              'kamaleon391@gmail.com' => 'impresos@info-gacomunicacion.com',
        ),
        "bcc" => array(
