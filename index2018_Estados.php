      ...
      <tr>
        ...
        <tr>
          ...
          if(numberNotes(5, $fecha))
            $mensaje .= "<td width='25%'  style='border-bottom: 1pt solid rgb(230, 230, 230);'><a href='http://187.247.253.5/PruebaCorreo/pemex/exportpemex.php?p=".base64_encode(base64_encode('5'))."&f=$fecha'>".'Clic aquí'."</a></td>";
          else
